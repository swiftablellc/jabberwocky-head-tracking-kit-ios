...
#ifndef JABBERWOCKYARKITENGINE_SWIFT_H
#define JABBERWOCKYARKITENGINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JabberwockyARKitEngine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class ARSession;
@class ARFaceAnchor;
@protocol HTEngineSettings;

SWIFT_CLASS("_TtC22JabberwockyARKitEngine13ARKitHTEngine") SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface ARKitHTEngine : NSObject
@property (nonatomic) BOOL isActivating;
@property (nonatomic) BOOL isEnabled;
@property (nonatomic, readonly, strong) ARSession * _Nonnull session;
@property (nonatomic, readonly, strong) ARFaceAnchor * _Nullable faceAnchor;
- (nonnull instancetype)initWithEngineSettings:(id <HTEngineSettings> _Nonnull)engineSettings OBJC_DESIGNATED_INITIALIZER;
...
@interface ARKitHTEngine (SWIFT_EXTENSION(JabberwockyARKitEngine)) <ARSessionDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface ARKitHTEngine (SWIFT_EXTENSION(JabberwockyARKitEngine)) <HTEngine>
- (void)enable;
- (void)disable;
